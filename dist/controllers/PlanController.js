...
const plan_service_1 = __importDefault(require("../services/plan.service"));
const planService = new plan_service_1.default();
exports.default = {
    // GET /api/admin/subscription/plan
    // Optional: ?onlyActive=true
    async getPlans(req, res) {
        try {
            const onlyActive = typeof req.query.onlyActive !== "undefined" &&
