...
const businessType_service_1 = __importDefault(require("../services/businessType.service"));
const storage_service_1 = require("../services/storage.service");
const BusinessType_1 = __importDefault(require("../models/BusinessType"));
this;
const service = new businessType_service_1.default();
exports.default = {
    // 🔹 PUBLIC: GET /businessType/getBusinessTypes (Laravel: getBusinessTypes)
    async getBusinessTypes(_req, res) {
        try {
            const businessTypes = await BusinessType_1.default.findAll({
    ...
    async update(req, res) {
        try {
            ...
            if (req.file) {
                (0, storage_service_1.deleteIfExists)(record.image);
